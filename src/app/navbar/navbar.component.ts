...
@Component({
  selector: 'app-navbar',
  standalone: true,
  imports: [CommonModule, MatToolbarModule, MatIconModule, MatButtonModule, MatSlideToggleModule, ReactiveFormsModule],
...
export class NavbarComponent {
  ...
  public isChecked$ = this.themeControl.valueChanges.pipe(
    ...
    tap((event: any) => {
      this.logoUrl = this.logoUrl === this.LOGO_DEFAULT ? this.LOGO_WHITE : this.LOGO_DEFAULT;
